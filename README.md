...
<ul>
  <li>☁️ Deploy and manage AWS Cloud Services</li>
  <li>🐧 Work with Linux-based environments</li>
  <li>🐳 Containerize applications using Docker</li>
  <li>⚙️ Build CI/CD pipelines using Jenkins</li>
  <li>🔄 Automate workflows using GitHub Actions</li>
  <li>🏗️ Provision infrastructure using Terraform</li>
  <li>☸️ Deploy and manage applications using Kubernetes</li>
  <li>🔐 Work with AWS IAM, VPC and Security Groups</li>
  <li>🐍 Use Python & Shell scripting for automation</li>
  <li>📊 Monitor and troubleshoot cloud infrastructure</li>
</ul>
